...
from annotator.util import resize_image, HWC3, transfer_classes_preserve_affordance
...
def process(input_image, prompt, a_prompt, n_prompt, num_samples, image_resolution, detect_resolution, ddim_steps, guess_mode, strength, scale, seed, eta):
    with torch.no_grad():
        ...
        detected_map = transfer_classes_preserve_affordance(detected_map)
...
with block:
    ...
    with gr.Row():
        ...
        with gr.Column():
            result_gallery = gr.Gallery(label='Output', show_label=True, elem_id="gallery").style(grid=2, height='auto')
